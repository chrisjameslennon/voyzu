import { CustomerSchema, CustomerGetResponseDto, CustomerFindByCodeResponseDto } from "../types/customer.internal-api.dto";
...
export const CustomerDefinition = {
  ...
  methods: {
    get: { ...PartyDefinition.methods.get, output: CustomerGetResponseDto },
    findByCode: { ...PartyDefinition.methods.findByCode, output: CustomerFindByCodeResponseDto },
