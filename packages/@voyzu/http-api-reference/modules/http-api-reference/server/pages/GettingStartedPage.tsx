    ...
    <main className={styles.page}>
      <header className={styles.header}>
        ...
        <p className={styles.description}>
          The HTTP API Reference documents Voyzu endpoints using relative paths. Combine each path with the base URL for the
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionText}>
          HTTP API requests and responses use JSON. Endpoints that accept a body expect <code>Content-Type:
