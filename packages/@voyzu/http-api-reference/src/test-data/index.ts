...
import type { HttpApiPageData, OperationDoc } from "../types/index";
import { operationDocToHttpApiOperationData } from "./operation-doc-adapter";
...
export const organizationsPageData: HttpApiPageData = {
  ...
  operations: organizationOperationDocs.map(operationDocToHttpApiOperationData),
};
