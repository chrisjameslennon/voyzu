...
const leftNav = [
  {
    ...
    items: [
      ...
      { label: "Context Switcher", icon: "switch_account", routeId: uiReferencePageRoutes.contextSwitcher.id },
      ...
      { label: "Textarea", icon: "notes", routeId: uiReferencePageRoutes.textarea.id },
