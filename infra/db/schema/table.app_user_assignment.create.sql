DROP TABLE IF EXISTS app_user_assignment CASCADE;

CREATE TABLE app_user_assignment (
    ...
    CONSTRAINT app_user_assignment_user_fk FOREIGN KEY (user_id) REFERENCES app_user(id) ON DELETE CASCADE,
    CONSTRAINT app_user_assignment_company_fk FOREIGN KEY (company_id) REFERENCES company(id) ON DELETE CASCADE,
