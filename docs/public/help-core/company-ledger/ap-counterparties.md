...
The detail brings together the supplier code and name with its AP documents, balance, applications, or linked entries where available. Use the stable code when reconciling data from an HTTP API client.
